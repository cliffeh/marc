...
$(BINARIES): %: %.o bin/main.o fields.o marc.o
	$(CC) $(CFLAGS) -o $@ $^
...
test: $(BINARIES)
	...
	bin/marc-debug -f 245a -f 260 -f 277abc > /dev/null && echo "basic debug test passed"
	bin/marc-print -l 10 $(DATA) > /dev/null && echo "basic print test passed"
